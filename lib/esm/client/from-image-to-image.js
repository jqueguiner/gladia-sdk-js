...
export class FromImageToImage {
    ...
    backgroundRemoval(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_IMAGE_BACKGROUND_REMOVAL_DEFAULT_MODEL,
            },
            body: formData,
        });
    }
    colorization(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_IMAGE_COLORIZATION_DEFAULT_MODEL,
            },
            body: formData,
        });
    }
    faceBluring(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_IMAGE_FACE_BLURING_DEFAULT_MODEL,
            },
            body: formData,
        });
    }
    uncolorization(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_IMAGE_UNCOLORIZATION_DEFAULT_MODEL,
            },
            body: formData,
        });
    }
