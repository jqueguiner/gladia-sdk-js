...
export class FromImageToText {
    ...
    asciify(args) {
        ...
        return this.httpClient.post({
            ...
            query: { model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_TEXT_ASCIIFY_DEFAULT_MODEL },
    ...
    classification(args) {
        ...
        return this.httpClient.post({
            ...
            query: { model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_TEXT_CLASSIFICATION_DEFAULT_MODEL },
            headers: { 'Content-Type': 'multipart/form-data' },
            body: formData,
        });
    }
    ocr(args) {
        ...
        return this.httpClient.post({
            url: '/image/text/ocr/',
            query: { model: (_a = args.model) !== null && _a !== void 0 ? _a : IMAGE_TEXT_OCR_DEFAULT_MODEL },
            headers: { 'Content-Type': 'multipart/form-data' },
            body: formData,
        });
    }
