...
export class FromTextToText {
    ...
    translation(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : TEXT_TEXT_TRANSLATION_DEFAULT_MODEL,
            },
            body: formData.toString(),
        });
    }
    ...
    articleGeneration(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : TEXT_TEXT_ARTICLE_GENERATION_DEFAULT_MODEL,
            },
            body: formData.toString(),
        });
    }
    adGeneration(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : TEXT_TEXT_AD_GENERATION_DEFAULT_MODEL,
            },
            body: formData.toString(),
        });
    }
    summarization(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : TEXT_TEXT_SUMMARIZATION_DEFAULT_MODEL,
            },
            body: formData.toString(),
        });
    }
    intentClassification(args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_a = args.model) !== null && _a !== void 0 ? _a : TEXT_TEXT_INTENT_CLASSIFICATION_DEFAULT_MODEL,
            },
            body: formData.toString(),
        });
    }
