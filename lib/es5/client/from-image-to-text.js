...
var FromImageToText = /** @class */ (function () {
    ...
    FromImageToText.prototype.asciify = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_TEXT_ASCIIFY_DEFAULT_MODEL,
            },
            body: formData,
        });
    };
    FromImageToText.prototype.classification = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_TEXT_CLASSIFICATION_DEFAULT_MODEL,
            },
            body: formData,
        });
    };
    FromImageToText.prototype.ocr = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_TEXT_OCR_DEFAULT_MODEL,
            },
            body: formData,
        });
    };
