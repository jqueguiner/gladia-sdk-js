...
var FromImageToImage = /** @class */ (function () {
    ...
    FromImageToImage.prototype.enhancement = function (args) {
        ...
        return this.httpClient.post({
            ...
            headers: tslib_1.__assign(tslib_1.__assign({ 'Content-Type': this.params.useFetch ? models_1.IMAGE_IMAGE_ENHANCEMENT_CONTENT_TYPE : undefined }, (args.asUrl ? { 'Accept': 'text/uri-list' } : {})), ((_a = args.headers) !== null && _a !== void 0 ? _a : {})),
            query: tslib_1.__assign({}, (args.model ? { model: args.model } : {})),
            responseType: args.asUrl ? 'json' : 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.faceBluring = function (args) {
        ...
        return this.httpClient.post({
            ...
            headers: tslib_1.__assign(tslib_1.__assign({ 'Content-Type': this.params.useFetch ? models_1.IMAGE_IMAGE_FACE_BLURING_CONTENT_TYPE : undefined }, (args.asUrl ? { 'Accept': 'text/uri-list' } : {})), ((_a = args.headers) !== null && _a !== void 0 ? _a : {})),
            query: tslib_1.__assign({}, (args.model ? { model: args.model } : {})),
            responseType: args.asUrl ? 'json' : 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.guidedInpainting = function (args) {
        ...
        return this.httpClient.post({
            ...
            headers: tslib_1.__assign(tslib_1.__assign({ 'Content-Type': this.params.useFetch ? models_1.IMAGE_IMAGE_GUIDED_INPAINTING_CONTENT_TYPE : undefined }, (args.asUrl ? { 'Accept': 'text/uri-list' } : {})), ((_a = args.headers) !== null && _a !== void 0 ? _a : {})),
            query: tslib_1.__assign({}, (args.model ? { model: args.model } : {})),
            responseType: args.asUrl ? 'json' : 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.imageGuidedInpainting = function (args) {
        ...
        return this.httpClient.post({
            ...
            headers: tslib_1.__assign(tslib_1.__assign({ 'Content-Type': this.params.useFetch ? models_1.IMAGE_IMAGE_IMAGE_GUIDED_INPAINTING_CONTENT_TYPE : undefined }, (args.asUrl ? { 'Accept': 'text/uri-list' } : {})), ((_a = args.headers) !== null && _a !== void 0 ? _a : {})),
            query: tslib_1.__assign({}, (args.model ? { model: args.model } : {})),
            responseType: args.asUrl ? 'json' : 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.inpainting = function (args) {
        ...
        return this.httpClient.post({
            ...
            headers: tslib_1.__assign(tslib_1.__assign({ 'Content-Type': this.params.useFetch ? models_1.IMAGE_IMAGE_INPAINTING_CONTENT_TYPE : undefined }, (args.asUrl ? { 'Accept': 'text/uri-list' } : {})), ((_a = args.headers) !== null && _a !== void 0 ? _a : {})),
            query: tslib_1.__assign({}, (args.model ? { model: args.model } : {})),
            responseType: args.asUrl ? 'json' : 'arraybuffer',
            body: formData,
        });
