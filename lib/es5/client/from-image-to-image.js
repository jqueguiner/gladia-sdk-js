...
var FromImageToImage = /** @class */ (function () {
    ...
    FromImageToImage.prototype.backgroundRemoval = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_IMAGE_BACKGROUND_REMOVAL_DEFAULT_MODEL,
            },
    ...
    FromImageToImage.prototype.colorization = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_IMAGE_COLORIZATION_DEFAULT_MODEL,
            },
            responseType: 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.faceBluring = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_IMAGE_FACE_BLURING_DEFAULT_MODEL,
            },
            responseType: 'arraybuffer',
            body: formData,
        });
    ...
    FromImageToImage.prototype.uncolorization = function (args) {
        ...
        return this.httpClient.post({
            ...
            query: {
                model: (_b = args.model) !== null && _b !== void 0 ? _b : models_1.IMAGE_IMAGE_UNCOLORIZATION_DEFAULT_MODEL,
            },
            responseType: 'arraybuffer',
            body: formData,
        });
