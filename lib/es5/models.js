...
exports.IMAGE_IMAGE_IMAGE_GUIDED_INPAINTING_CONTENT_TYPE = "multipart/form-data";
...
exports.TEXT_TEXT_IMAGE_GENERATION_PROMPT_BEAUTIFIER_MODELS = [
    'ms-promptist',
];
exports.TEXT_TEXT_IMAGE_GENERATION_PROMPT_BEAUTIFIER_CONTENT_TYPE = "application/x-www-form-urlencoded";
...
exports.VIDEO_TEXT_ACTION_CLASSIFICATIONS_MODELS = [
    'kinetics--MCG-NJU/videomae-base-finetuned-kinetics',
    'kinetics--facebook/timesformer-base-finetuned-k400',
];
exports.VIDEO_TEXT_ACTION_CLASSIFICATIONS_CONTENT_TYPE = "multipart/form-data";
