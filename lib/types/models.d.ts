...
export declare const TEXT_TEXT_TRANSLATION_MODELS: readonly ["nllb-200-3-3b"];
export declare const TEXT_TEXT_TRANSLATION_CONTENT_TYPE: "application/x-www-form-urlencoded";
export declare const TEXT_TEXT_TRANSLATION_DEFAULT_MODEL: "nllb-200-3-3b";
...
export declare const TEXT_TEXT_ARTICLE_GENERATION_DEFAULT_MODEL: "fast-gpt-j";
...
export declare const TEXT_TEXT_AD_GENERATION_DEFAULT_MODEL: "gpt-j";
export declare type TextTextAdGenerationModel = typeof TEXT_TEXT_AD_GENERATION_MODELS[number];
export declare const TEXT_TEXT_SUMMARIZATION_MODELS: readonly ["bart-large-cnn"];
export declare const TEXT_TEXT_SUMMARIZATION_CONTENT_TYPE: "application/x-www-form-urlencoded";
export declare const TEXT_TEXT_SUMMARIZATION_DEFAULT_MODEL: "bart-large-cnn";
...
export declare const TEXT_TEXT_INTENT_CLASSIFICATION_DEFAULT_MODEL: "fast-gpt-j";
