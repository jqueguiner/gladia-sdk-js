...
export declare const TEXT_TEXT_EMOTION_RECOGNITION_MODELS: readonly ["distilbert-base-uncased-emotion"];
...
export declare const TEXT_TEXT_HATE_SPEECH_DETECTION_MODELS: readonly ["distilbert-base-uncased-emotion"];
...
export declare const TEXT_TEXT_HEADLINE_GENERATION_MODELS: readonly ["t5-base-en-generate-headline"];
