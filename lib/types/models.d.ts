...
export declare const TEXT_TEXT_HATE_SPEECH_DETECTION_MODELS: readonly ["distilbert-base-uncased-emotion", "dkleczek_Polish-Hate-Speech-Detection-Herbert-Large"];
...
export declare const TEXT_TEXT_LANGUAGE_GENERATION_MODELS: readonly ["gpt2_xl"];
...
export declare const TEXT_TEXT_NAMED_ENTITY_RECOGNITION_MODELS: readonly ["dbmdz-bert-large-cased-finetuned-conll03-english_deepspeed", "spacy-en"];
