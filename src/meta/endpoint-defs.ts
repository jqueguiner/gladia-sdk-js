...
export const ENDPOINT_DEFS: EndpointDef[] = [
  ...
  },
  {
    ...
    models: ['pyannote-speaker_diarization'],
  ...
  },
  {
    ...
    models: ['cnn_lstm_parallel_model'],
  ...
  },
  {
    ...
    models: ['deoldify-artistic', 'deoldify-stable', 'mlhubber_colorize'],
  ...
  },
  {
    ...
    outputType: 'image',
    taskName: 'inpainting',
    models: ['fcf', 'lama', 'latent-diffusion', 'mat', 'zits'],
    defaultModel: 'zits',
    inputBodyContentType: 'multipart/form-data',
    outputBodyContentType: {
      type: 'binary',
  ...
  },
  {
    ...
    outputType: 'text',
    taskName: 'ocr',
    models: ['easy-ocr', 'tesseract-default', 'tesseract-denoising', 'textract-extractor'],
  ...
  },
  {
    ...
    models: ['flexudy-t5-base-multi-sentence-doctor'],
  ...
  },
  {
    ...
    models: ['bhadresh-savani_distilbert-base-uncased-emotion'],
    ...
    params: [
      {
        ...
        type: 'array',
        name: 'texts',
        example: ['I love you.', 'I hate you.', 'I am happy.'],
        required: true,
      },
    ],
    hasSamplesParam: false,
  ...
  },
  {
    ...
    models: ['jpt', 'michau-t5-base-en-generate-headline'],
    defaultModel: 'jpt',
    inputBodyContentType: 'application/x-www-form-urlencoded',
    outputBodyContentType: {
      type: 'prediction-standard-output',
  ...
  },
  {
    ...
    models: ['keybert-paraphrase-multilingual-MiniLM-L12-v2'],
    ...
    params: [
      {
        ...
        name: 'text',
        example:
          'I love ETFs and have invested some money in the stock market and also have a pension plan',
        required: true,
      },
    ],
    hasSamplesParam: false,
  ...
  },
  {
    ...
    models: ['deepset_roberta-large-squad2', 'distilbert-base-cased-distilled-squad'],
  ...
  },
  {
    ...
    models: ['google_pegasus-cnn_dailymail'],
  ...
  },
  {
    ...
    models: ['facebook-nllb-200-distilled-600M', 'jpt'],
    defaultModel: 'jpt',
    inputBodyContentType: 'application/x-www-form-urlencoded',
    outputBodyContentType: {
      type: 'prediction-standard-output',
